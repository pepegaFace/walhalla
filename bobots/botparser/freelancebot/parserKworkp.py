...
class Client:
    ...
    def load_page(self, page: int = None,):
        url = 'https://kwork.ru/projects?c=11&keyword=python'
    ...
    def save_result(self):
        ...
        if not os.path.isfile('kworkp_data.json'):
            with open('kworkp_data.json', 'w') as f:
            ...
            if existing_data:
                for item in self.dictionary_list:
                    if any(item['url'] in s for s in existing_data):
